...
rec=[]
tfr=[]
rw.readallframes("/Users/percychien/Desktop/project/pig-main/test/"+filename+".bag",0,50,red,rec,tfr )
print(tfr)
...
rec=[]
tfr=[]
rw.readallframes("/Users/percychien/Desktop/project/pig-main/test/board/before"+filename+".bag",0,50,red,rec,tfr )
...
re=pc.findvec(gp,reddot,red[20],rec[20],debug=debug)
vx=re[0]
vy=re[1]
vz=re[2]
p=re[3]
